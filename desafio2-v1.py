...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
    ...
    if excedeu_saldo:
        print("\nSaque não realizado! Saldo suficiente.")

    elif excedeu_limite:
        print("\nSaque não realizado! Limite de saque excedido.")

    elif excedeu_saques:
        print("\nSaque não realizado! Quantidade de saques excedida.")
        ...
        print("\nSaque não realizado! O valor inválido.")
